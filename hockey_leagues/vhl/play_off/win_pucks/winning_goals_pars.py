...
URL = ['http://www.vhlru.ru/stats/leaders/875/gwg/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'vhl_play_off_winning_goals'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'club','number', 'played_games', 'scored_goals', 'assists', 'points', 'plus_minus',
                   'winning_goals', 'average_time_per_game']  # и так далее. Это список самих полей
