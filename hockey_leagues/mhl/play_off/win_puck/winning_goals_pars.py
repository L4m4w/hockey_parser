...
URL = ['https://mhl.khl.ru/stat/leaders/860/gwg/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'mhl_play_off_winning_goals'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number','club', 'roll','played_games', 'scored_goals', 'assists', 'points', 
                   'plus_minus', 'winning_goals']  # и так далее. Это список самих полей
