...
URL = ['https://mhl.khl.ru/stat/leaders/860/hits/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'mhl_play_off_power_tricks'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number','club', 'roll','played_games', 'scored_goals', 'assists', 'points',
                   'plus_minus', 'power_tricks', 'penalty_time' ]  # и так далее. Это список самих полей
