...
URL = ['https://mhl.khl.ru/stat/leaders/860/gaa/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'mhl_play_off_goalkeepers_safety_factor'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number','club', 'roll','played_games', 'winnings', 'losing', 'pors', 'safety_factor',
