...
URL = ['https://www.khl.ru/stat/leaders/854/toi_avg_def/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'khl_play_off_playing_time_defenders'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number', 'club', 'played_games', 'scored_goals', 'assists', 'points', 'plus_minus',
                   'average_time_per_game', 'average_shifts_per_game']  # и так далее. Это список самих полей
