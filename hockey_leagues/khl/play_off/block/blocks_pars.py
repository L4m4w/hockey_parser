...
URL = ['https://www.khl.ru/stat/leaders/854/bls/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'khl_play_off_blocked_throws'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number', 'club', 'roll', 'played_games', 'blocked_throws', 'plus_minus',
                   'penalty_time', 'average_time_per_game','average_shifts_per_game']  # и так далее. Это список самих полей
