...
URL = ['https://www.khl.ru/stat/leaders/854/pim/']
...
def get_content(html):
    ...
    # statistics_db = []
    table_name = 'khl_play_off_penalty'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number', 'club', 'played_games', 'scored_goals', 'assists', 'points', 'plus_minus',
                   'penalty_time', 'average_penalty_time_per_game']  # и так далее. Это список самих полей
