...
URL = ['https://www.khl.ru/stat/leaders/854/hits/' ]
...
def get_content(html):
    ...
    #statistics_db = []
    table_name = 'khl_play_off_power_tricks'  # это название таблицы, куда пихаем (не бд)
    fields_name = ['place', 'name', 'number', 'club', 'played_games', 'power_tricks', 'plus_minus', 'penalty_time', 'average_time_per_game',
                   'average_shifts_per_game']  # и так далее. Это список самих полей
